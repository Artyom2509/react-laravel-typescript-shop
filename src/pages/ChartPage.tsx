			...
			<Row>
				<Col xl={6} lg={12} md={12}>
					<Card>
						...
						<CardBody>
							<Bar data={genLineData() as ChartData} />
						</CardBody>
					</Card>
				</Col>
				...
				<Col xl={6} lg={12} md={12}>
					<Card>
						...
						<CardBody>
							<Line data={genLineData({ fill: false }, { fill: false }) as ChartData} />
						</CardBody>
					</Card>
				</Col>
			</Row>
			...
			<Row>
				...
				<Col xl={6} lg={12} md={12}>
					<Card>
						...
						<CardBody>
							<Bar data={genLineData({ type: 'line', fill: false }) as ChartData} />
						</CardBody>
					</Card>
				</Col>
			</Row>
			...
			<Row>
				...
				<Col xl={6} lg={12} md={12}>
					<Card>
						...
						<CardBody>
							<Doughnut data={genPieData() as ChartData} />
						</CardBody>
					</Card>
				</Col>
			</Row>
			...
			<Row>
				<Col xl={6} lg={12} md={12}>
					<Card>
						...
						<CardBody>
							<Polar data={genPieData() as ChartData} />
						</CardBody>
					</Card>
				</Col>
				...
				<Col xl={6} lg={12} md={12}>
					<Card>
						...
						<CardBody>
							<Radar data={genLineData() as ChartData} />
						</CardBody>
					</Card>
				</Col>
			</Row>
